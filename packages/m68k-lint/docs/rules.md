...
132 built-in rules. `m68k-lint --list-rules` prints the same set.
...
| `optimization/carry-to-mask-via-subx` | suggestion | Use SUBX to turn the carry into an all-ones mask | EAB 68000 code optimisations |
